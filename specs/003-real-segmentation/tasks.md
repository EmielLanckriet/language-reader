...
- [ ] T091 Verify in a browser that an interrupted upgrade resumes where it stopped rather than restarting, using a deliberately slow fake analyzer so the check does not depend on the 98 MB download that T082 cannot yet run headless
